...
class CocoHandDataset(BaseDataset):
    ...
    def get_per_img_info(self, idx):
        ...
        info = {"image_path": image_path, "height": height, "width": width, "id": id}
        return info
    ...
    def get_img_annotation(self, idx):
        ...
        for ann in anns:
            ...
            #     continue
            if w < 1 or h < 1:   # no area attr in this dataset
                continue
    ...
    def get_train_data(self, idx):
        ...
        #     x1, y1, x2, y2 = bbox
        #     img_with_bbox = cv2.rectangle(img_with_bbox, (int(x1), int(y1)), (int(x2), int(y2)), color=(0, 0, 255), thickness=2)
        #     img_with_bbox = cv2.putText(img_with_bbox, str(label), (int(x1), int(y1)), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 1)
        # img_save_path = '/home/zg/wdir/zg/moyu/GestureDet/nanodet/workspace/dummy_samples/' + str(idx) + '.jpg'
