...
class GFLHead(nn.Module):
    ...
    def post_process(self, preds, meta):
        ...
        # print(preds.shape, cls_scores.shape, bbox_preds.shape)
        # use trt: torch.Size([1, 2100, 35]) torch.Size([1, 2100, 3]) torch.Size([1, 2100, 32])
        # not use trt: torch.Size([1, 1680, 35]) torch.Size([1, 1680, 3]) torch.Size([1, 1680, 32])
        # input()
    ...
    def get_bboxes(self, cls_preds, reg_preds, img_metas):
        ...
        # print(self.distribution_project(reg_preds).shape, center_priors.shape) 
        # use trt: torch.Size([1, 2100, 4]) torch.Size([1, 1680, 4])
        # not use trt: torch.Size([1, 1680, 4]) torch.Size([1, 1680, 4])
        # input()

        # use trt: torch.Size([1, 2100, 32])
        # not use trt: torch.Size([1, 1680, 32])
        # input()
