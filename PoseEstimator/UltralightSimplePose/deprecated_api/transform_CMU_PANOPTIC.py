...
class SimpleTransform(object):
    def __init__(self, input_size, output_size, train):
        self.input_size = input_size
        self.output_size = output_size
        self.feat_stride = np.array(self.input_size) / np.array(self.output_size)
        self.data_aug = train
    ...
    def __call__(self, img, label):
        ...
        bbox = get_bbox_from_joints(joints, height, width)
